...
const RoutePlanner = () => {
  ...
  const { desiredKm } = useLocation().state || {};
    ...
    <div className="min-h-dvh pt-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 py-10 md:py-20">
          {/* {map} */}
          <div className="h-80 md:h-150 w-full flex items-center justify-center rounded-2xl lg:col-span-3">
            <Map km={desiredKm} />
          </div>

          {/* {info} */}
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-3.5 lg:col-span-2">
            <div className="p-2 flex flex-col rounded-lg items-center justify-center bg-[#1a1a1a]">
